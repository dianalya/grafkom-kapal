...
void RenderScene(void)
 ...
 //karang
 glTranslatef(-45.0, -10.0, 0.0f);
 glRotatef(90, 1.0f, 1.0f, 0.0f);
 glBegin(GL_POLYGON);
 glColor3ub(221, 221, 225);
 glVertex3f(-5.0, -23.0, 0.0);
 glVertex3f(-5.0, 24.0, 0.0);
 glVertex3f(-3.0, 25.0, 0.0);
 glVertex3f(-1.0, 22.0, 0.0);
 glVertex3f(5.0, 28.0, 0.0);
 glVertex3f(7.0, 24.0, 0.0);
 glVertex3f(9.0, 26.0, 0.0);
 glVertex3f(11.0, 23.0, 0.0);
 glVertex3f(13.0, 26.0, 0.0);
 glVertex3f(13.0, -30.0, 0.0);
 glEnd();

 /*glTranslatef(5.0, -10.0, 0.0f);
 glRotatef(-90, 1.0f, 1.0f, 0.0f);
 glBegin(GL_POLYGON);
 glColor3ub(221, 221, 0);
 glVertex3f(15.0, -23.0, 0.0);
 glVertex3f(-5.0, 24.0, 0.0);
 glVertex3f(-3.0, 25.0, 0.0);
 glVertex3f(-1.0, 22.0, 0.0);
 glVertex3f(5.0, 28.0, 0.0);
